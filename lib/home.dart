            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text("Hi, Jonathan!", style: themeData.textTheme.headlineMedium,),
...
class _CategoryList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CarouselSlider.builder(
      ...
      return _CategoryItem(category: categories[realIndex],
       left: realIndex==0?32:8, right: realIndex==categories.length-1?32:8,);
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                    Text(post.caption, style: const TextStyle(fontFamily: FontFamily.avenir,
                     ...
                     Row(
                      ...
                      children: [
                        Icon(CupertinoIcons.hand_thumbsup, size: 16,color: Theme.of(context).textTheme.bodySmall!.color,),
                        ...
                        Expanded(child: Container(
                          ...
                          child: Icon(post.isBookmarked?CupertinoIcons.bookmark_fill:CupertinoIcons.bookmark, size: 16,
                          color: Theme.of(context).textTheme.bodySmall!.color),
                        ),)
